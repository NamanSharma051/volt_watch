...
class SettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    const Color primaryColor = Color(0xFF00FF88);
      ...
      body: ListView(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
                fontSize: 12, color: isDark ? Colors.white38 : Colors.black54),
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        '${settings.threshold.clamp(5, 30)}.0%',
                ...
                Slider(
                  value: settings.threshold.clamp(5, 30).toDouble(),
                  min: 5.0,
                  max: 30.0,
                  divisions: 25,
                ...
                Row(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Warning Threshold Offset',
                            style: TextStyle(
                                fontSize: 13, fontWeight: FontWeight.w600)),
                        Text('Delta above critical level',
                            style: TextStyle(
                                fontSize: 11,
                                color:
                ...
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text('Data Polling Interval',
                            style: TextStyle(
                                fontSize: 13, fontWeight: FontWeight.w600)),
                        Container(
                          ...
                          child: DropdownButton<double>(
                            ...
                            onChanged: (val) {
                              if (val != null) {
                                ...
                                ref
                                    .read(batteryViewModelProvider.notifier)
                                    .updatePollingInterval(val);
                                ref
                                    .read(settingsViewModelProvider.notifier)
                            ...
                            items: const [
                              DropdownMenuItem(
                                  value: 1.0, child: Text('1.0 s (Standard)')),
                              DropdownMenuItem(
                                  value: 5.0, child: Text('5.0 s (Telemetry)')),
                              DropdownMenuItem(
                                  value: 15.0,
                                  child: Text('15.0 s (Battery Saver)')),
                            ],
                          ),
                        ),
                      ],
                    ...
                    SwitchListTile(
                      ...
                      title: const Text('Predictive Smoothing',
                          style: TextStyle(
                              fontSize: 13, fontWeight: FontWeight.w600)),
                      subtitle: Text('Apply Kalman filter to voltage spikes',
                          style: TextStyle(
                              fontSize: 11,
                              color: isDark ? Colors.white24 : Colors.black38)),
              ...
              child: Column(
                children: [
                  ...
                  Divider(
                      ...
                      height: 1),
                  SwitchListTile(
                    title: const Text('Absolute Values',
                        style: TextStyle(
                            fontSize: 13, fontWeight: FontWeight.w600)),
          ...
          ClipRRect(
            ...
            child: Material(
              ...
              child: Column(
                children: [
                  SwitchListTile(
                    title: const Text('Threshold Feedback',
                        style: TextStyle(
                            fontSize: 13, fontWeight: FontWeight.w600)),
                  ...
                  Divider(
                      ...
                      height: 1),
                  SwitchListTile(
                    title: const Text('UI Interactions',
                        style: TextStyle(
                            fontSize: 13, fontWeight: FontWeight.w600)),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: settings.isExecutingDiagnostics
                        ...
                        : const Text('EXECUTE DIAGNOSTICS',
                            style: TextStyle(
                                fontWeight: FontWeight.w900,
                                fontSize: 11,
                                letterSpacing: 0.5)),
                      ...
                      child: ChoiceChip(
                        ...
                        onSelected: (selected) {
                          if (selected) {
                            ...
                            ref
                                .read(settingsViewModelProvider.notifier)
                                .setActiveProfile('High Performance');
                          }
                        },
                      ...
                      child: ChoiceChip(
                        ...
                        onSelected: (selected) {
                          if (selected) {
                            ...
                            ref
                                .read(settingsViewModelProvider.notifier)
                                .setActiveProfile('Battery Saver');
                          }
                        },
                        selectedColor: primaryColor.withValues(alpha: 0.15),
                        checkmarkColor: primaryColor,
          ...
          Material(
            ...
            child: ListTile(
              ...
              subtitle:
                  const Text('Deletes all persistent database log metrics'),
              onTap: () {
                if (settings.uiHaptics) {
                  HapticFeedback.mediumImpact();
                }
  ...
  void _showClearLogsDialog(BuildContext context, WidgetRef ref) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('Clear Log Telemetry',
            style: TextStyle(color: isDark ? Colors.white : Colors.black87)),
        content: Text(
            'Are you sure you want to delete all battery metrics history? This action is irreversible.',
